...
> **Не читать папку `_archive/`** — там завершённые брифы и устаревшие статусные документы,
> оставленные для справки владельца проекта. Они не отражают текущее состояние кода.
